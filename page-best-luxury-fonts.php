...
kreativ_render_dynamic_font_collection_page(
    array(
        ...
        'summary'        => 'A dynamic collection of luxury fonts for premium brands, beauty systems, fashion campaigns, packaging, hospitality, and high-end editorial work.',
        'side_title'     => 'Use luxury fonts when perception matters.',
        'side_copy'      => 'This page pulls from the Luxury mood branch, keeping the collection focused on typefaces that feel premium, polished, and brand-forward.',
        ...
        'intro_points'   => array(
            ...
            'Pulls from the Luxury mood branch.',
